...
const projects = [
  {
    ...
    demoUrl: "#",
    githubUrl: "https://github.com/camilagermanoo/portfolio",
  },
  {
    id: 2,
    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Projetos desenvolvidos com atenção aos detalhes, boas práticas e foco 
          na entrega de soluções eficientes.
        </p>
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/camilagermanoo"
          >
